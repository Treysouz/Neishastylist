...
export default function HeroSection() {
  return (
    <SectionWrapper
      id="hero"
      className="bg-logo-dark h-dvh flex flex-col sm:flex-row space-x-16">
      ...
      <div className="w-full h-full bg-logo-dark flex flex-col  justify-center space-y-12 ">
        <p className="text-6xl text-white  leading-20">
          If You Can Dream It, <br></br> We Can Achieve It
        </p>
        <div>
          <button className="btn btn-primary text-white btn-xl">
